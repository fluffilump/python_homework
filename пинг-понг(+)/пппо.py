import pygame
pygame.mixer.init()
pygame.mixer.music.load('soundsss\саундтрек.mp3')
...
while True:
    ...
    if ball.ycor() >= rocket_b.ycor()-50 and ball.ycor() <= rocket_b.ycor()+50 \
       and ball.xcor() >= rocket_b.xcor()-15 and ball.xcor() <= rocket_b.xcor()+15:
       ball.dx = -ball.dx

    if ball.ycor() >= rocket_a.ycor()-50 and ball.ycor() <= rocket_a.ycor()+50 \
       and ball.xcor() >= rocket_a.xcor()-15 and ball.xcor() <= rocket_a.xcor()+15:
       ball.dx = -ball.dx
